...
\begin{itemize}
\item \textbf{Idempotent}: Assuming an absence of new input, and with self-recurrent connections of 1.0, long term, high precision storage of information is possible without any specialized architectural design.
\begin{equation}
\textrm{abs}(\mathbf{x}) =
