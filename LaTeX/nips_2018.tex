...
\subsection{Experimental Configuration}
 Diagnet is initialized as follows.  We use RMSProp [REF] as a gradient descent optimizer, with a learning rate of .001.  All recurrent parameters are initialized to 1.0, and feedforward parameters use Xavier's initialization [REF]. The global gradient norm is clipped at 30.0, while per-parameter gradients are clipped at [-1,1].  Finally, an unbiased hidden layer allows for the idempotency of the absolute value function. 
%\begin{table}[ht]
