...
\subsection{Efficient RTRL implementation}
...
\begin{equation}
{\left[ {\frac{\partial f_j}{\partial w_j}} \right]}_t := \textrm{sgn} \left( \left[ \sum_{i, j} x_{i_t} w_{ij }\right] + r f_{j_{t-1}} \right) + r {\left[ {\frac{\partial f_j}{\partial w_j}} \right]}_{t-1}
\end{equation}
